...
# ── 4. KEEP ONLY CLOSED TRADES & RENAME COLUMN ───────────────
...
# ── 7. SENTIMENT PERFORMANCE SUMMARY ────────────────────────
agg_dict = {
...
# ── 8. PLOT 1 — Win Rate, Avg PnL, Leverage by Sentiment ────
...
# ── 9. PLOT 2 — Long vs Short by Sentiment ───────────────────
if 'Side' in merged.columns:
    ...
    # plt.show()  <-- Commented out so the script doesn't pause here!

# ── 10. PLOT 3 — Daily PnL Timeline ──────────────────────────
...
if 'account' in merged.columns:
    ...
    top10 = pd.DataFrame()
    print("\n⚠️  No 'account' column found — skipping top traders.")
